...
-- monitor=HDMI-A-1,highrr,auto,1,mirror,eDP-2
...
local configs = "~/.config/hypr/"
-- source = $configs/keybinds.conf
-- Source: $configs/nvidia.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("nvidia")
-- Source: $configs/keybinds.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("keybinds")
-- Source: $configs/startup.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("startup")
-- Source: $configs/windowrules.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("windowrules")
-- Source: $configs/monitors.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("monitors")
...
hl.config({
    ...
    -- bind = $mainMod, E, exec, wofi # Show the graphicall app launcher
